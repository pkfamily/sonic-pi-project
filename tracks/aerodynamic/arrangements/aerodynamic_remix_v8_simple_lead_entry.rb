# Simple-lead-entry remix derived from aerodynamic_remix_v7_lead_drop.rb.
#
...
# V7's later arrangement and corrected post-bell fill remain intact. Its final
# four opening bars instead shed layers one at a time, ending with a dry,
# truncated funk phrase and more than one beat of silence before the lead.
...
# 0:16-1:12: extended groove ending in a four-bar layer subtraction.
...
opening_groove_bars.times do |bar|
  ...
  if bar >= 20
    if bar < 24
      ...
      in_thread do
        opening_bass_bar source_measure - 9,
          subtraction_bass_amps[bar - 24],
          subtraction_bass_cutoffs[bar - 24]
      end
